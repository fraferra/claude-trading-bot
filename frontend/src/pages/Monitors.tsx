...
const MONITOR_TYPES = [
  ...
  { id: 'cross_platform_arb', label: 'Cross-Platform Arb', desc: 'Polymarket ↔ Kalshi price spread detection' },
  { id: 'weather_arb', label: 'Weather Arbitrage', desc: 'NOAA forecast vs Polymarket weather markets (1-7 day window)' },
  { id: 'kalshi_prediction', label: 'Kalshi Prediction', desc: 'Autonomous Kalshi prediction market trading' },
  { id: 'kalshi_arb', label: 'Kalshi Arbitrage', desc: 'MECE multi-outcome arbitrage on Kalshi' },
  { id: 'crypto_momentum', label: 'Crypto Momentum', desc: '15-min crypto momentum/mean-reversion strategy' },
  { id: 'regime_classifier', label: 'Regime Classifier', desc: 'OU-process market regime detection for crypto' },
